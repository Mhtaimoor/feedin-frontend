...
export default function BrandCard() {
  return (
    <>
      <div className="BrandCard px-10 lg:px-20">
        <a
          href="#"
          class="flex flex-col items-center bg-gray-400 border border-gray-200 rounded-lg shadow md:flex-row md:max-w-full hover:bg-gray-100 border-gray-700 bg-gray-800 hover:bg-gray-700"
        >
          <img
