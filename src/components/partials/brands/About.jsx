      ...
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12 reveal">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 revealUp">
            It is a long established fact that a person is wanted to have
            delicious meals near his comfort zone, and in order to do the
            honours FEEDINN tells you where to go.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
          <img
